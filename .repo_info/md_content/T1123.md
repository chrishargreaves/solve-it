...
# <span style="background-color: #D9EAD3; padding: 12px 14px; border-radius: 2px; display: inline-block; vertical-align: 2px;"> </span> T1123
...
- W1199: Excessive keyword results returned from case-specific wordlists such that careful review of all results is impractical _(INCOMP)_
...
- W1192: Relevant results not captured by the case-specific keywords used _(INCOMP)_
