...
# <span style="background-color: #D9EAD3; padding: 12px 14px; border-radius: 2px; display: inline-block; vertical-align: 2px;"> </span> T1003
...
- W1029: Memory smearing may result in pointers being inconsistent within the memory image _(INAC-AS, INAC-COR)_
...
- W1030: Loading a memory imaging tool makes changes to the data in memory that is being acquired _(INAC-ALT)_
    - M1087: Acquire memory from outside of the target system for example using direct memory access (DMA) devices 
- W1031: Loading a memory imaging tool overwrites relevant data within memory _(INCOMP)_
- W1032: Not all memory is acquired _(INCOMP)_
- W1033: Data referenced in memory is located within pagefile or swapfile but is not collected _(INCOMP)_
